    ...
    <>
      <div className="container">
        <div className="mb-3">
          ...
          <button className="btn btn-primary" onClick={handleExtraScaces}>
            Remove Extra Space
          </button>
          {/* Text Area */}
          <textarea
          ...
          <button className="btn btn-primary" onClick={capitilizeSentence}>
            Capitilize sentence
          </button>
          <button className="btn btn-primary mx-3" onClick={capitilizeWords}>
            Capitilize sentence
          </button>
        </div>
      </div>
      ...
      <div className="container">
        <h2>Text Summary</h2>
        <p>
          Words: {text.trim().split(/\s+/).filter(Boolean).length} and
